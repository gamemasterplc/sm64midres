...
static Vp sEndCutsceneVp = { { { (SCREEN_WIDTH*2), (SCREEN_HEIGHT*2), 511, 0 }, { (SCREEN_WIDTH*2), (SCREEN_HEIGHT*2), 511, 0 } } };
...
void print_displaying_credits_entry(void) {
    ...
    if (sDispCreditsEntry != NULL) {
        ...
        strY = (sDispCreditsEntry->unk02 & 0x20 ? 28 : (SCREEN_HEIGHT-68)) + (numLines == 1) * 16;
#ifndef VERSION_JP
        lineHeight = 16;
#endif
        ...
        while (numLines-- > 0) {
            print_credits_str_ascii((SCREEN_WIDTH - 28) - get_credits_str_width(*currStrPtr), strY, *currStrPtr);
...
static void end_peach_cutscene_dialog_1(struct MarioState *m) {
    ...
    switch (m->actionTimer) {
        ...
        case 230:
            set_cutscene_message((SCREEN_WIDTH/2), (SCREEN_HEIGHT-13), 0, 30);
#ifndef VERSION_JP
        ...
        case 290:
            set_cutscene_message((SCREEN_WIDTH/2), (SCREEN_HEIGHT-13), 1, 60);
#ifndef VERSION_JP
...
static void end_peach_cutscene_dialog_2(struct MarioState *m) {
    ...
    switch (m->actionTimer) {
        case 29:
            set_cutscene_message((SCREEN_WIDTH/2), (SCREEN_HEIGHT-13), 2, 30);
#ifndef VERSION_JP
        ...
        case 75:
            set_cutscene_message((SCREEN_WIDTH/2), (SCREEN_HEIGHT-13), 3, 30);
#ifndef VERSION_JP
        ...
        case 130:
            set_cutscene_message((SCREEN_WIDTH/2), (SCREEN_HEIGHT-13), 4, 40);
#ifndef VERSION_JP
...
static void end_peach_cutscene_dialog_3(struct MarioState *m) {
    ...
    switch (m->actionTimer) {
        case 1:
            ...
            sEndToadAnims[1] = 2;
            D_8032CBE8 = 1;
            set_cutscene_message((SCREEN_WIDTH/2), (SCREEN_HEIGHT-13), 5, 30);
#ifndef VERSION_JP
        ...
        case 55:
            set_cutscene_message((SCREEN_WIDTH/2), (SCREEN_HEIGHT-13), 6, 40);
            break;

        case 130:
            set_cutscene_message((SCREEN_WIDTH/2), (SCREEN_HEIGHT-13), 7, 50);
#ifndef VERSION_JP
...
static void end_peach_cutscene_run_to_castle(struct MarioState *m) {
    ...
    if (m->actionTimer == 95) {
        set_cutscene_message((SCREEN_WIDTH/2), (SCREEN_HEIGHT-13), 0, 40);
#ifndef VERSION_JP
