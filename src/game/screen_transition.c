...
s32 func_802CB9F8(s8 spBB, s8 spBF, struct WarpTransitionData *transData, s8 spC7, s8 spCB) {
    ...
    if (spA8 != NULL) {
        ...
        gDPSetCombine1CycleLERP(gDisplayListHead++,
                            0, 0, 0, SHADE,  // CCMUX
                            0, 0, 0, SHADE); // ACMUX
        gDPSetRenderMode(gDisplayListHead++, G_RM_RA_OPA_SURF, G_RM_AA_OPA_SURF2)
...
Gfx *func_802CC2E8(void) {
    ...
    if (verts != NULL && dlist != NULL) {
        ...
        make_vertex(verts, 0, 0, 0, -1, -1152, (1008+((SCREEN_HEIGHT*1088)/SCREEN_WIDTH)), 0, 0, 0, 255);
        make_vertex(verts, 1, SCREEN_WIDTH, 0, -1, 1152, (1008+((SCREEN_HEIGHT*1088)/SCREEN_WIDTH)), 0, 0, 0, 255);
        make_vertex(verts, 2, SCREEN_WIDTH, SCREEN_HEIGHT, -1, 1152, (1008-((SCREEN_HEIGHT*1088)/SCREEN_WIDTH)), 0, 0, 0, 255);
        make_vertex(verts, 3, 0, SCREEN_HEIGHT, -1, -1152, (1008-((SCREEN_HEIGHT*1088)/SCREEN_WIDTH)), 0, 0, 0, 255);
		#else
		make_vertex(verts, 0, 0, 0, -1, -((1728*SCREEN_WIDTH)/SCREEN_HEIGHT), 1824, 0, 0, 0, 255);
        make_vertex(verts, 1, SCREEN_WIDTH, 0, -1, ((1728*SCREEN_WIDTH)/SCREEN_HEIGHT), 1824, 0, 0, 0, 255);
        make_vertex(verts, 2, SCREEN_WIDTH, SCREEN_HEIGHT, -1, ((1728*SCREEN_WIDTH)/SCREEN_HEIGHT), 192, 0, 0, 0, 255);
        make_vertex(verts, 3, 0, SCREEN_HEIGHT, -1, -((1728*SCREEN_WIDTH)/SCREEN_HEIGHT), 192, 0, 0, 0, 255);
		#endif
